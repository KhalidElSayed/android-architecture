...
package com.example.android.architecture.blueprints.todoapp.ui.taskdetail.navigator;
...
public class TaskDetailNavigator {
    ...
    @Inject
    public TaskDetailNavigator(@NonNull @Named("taskDetailNavigationProvider") BaseNavigator navigationProvider) {
     ...
     */
    public void onStartEditTask(Integer taskId) {
